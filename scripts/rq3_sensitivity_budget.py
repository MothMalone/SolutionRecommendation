...
def main() -> int:
    ...
    variants = [
        {"name": "ants5_iter1", "flags": ["--n-ants", "5", "--n-iterations", "1"]},
        {"name": "ants5_iter2", "flags": ["--n-ants", "5", "--n-iterations", "2"]},
        {"name": "ants5_iter3", "flags": ["--n-ants", "5", "--n-iterations", "3"]},
        {"name": "ants5_iter4", "flags": ["--n-ants", "5", "--n-iterations", "4"]},
