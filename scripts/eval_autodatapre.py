...
def score_prepared(
    ...
    *,
    ...
    """Score one AutoDP-prepared dataset with our AutoGluon protocol. Returns the result dict.
...
def main() -> None:
    ...
    print(f"[ok  ] {result['dataset_id']} ({result['mode']}) {result['eval_metric']}: "
          ...
          f"eval={result['autogluon_eval_seconds']}s -> {out_path}")
